...
    // Replacing /talk with /nepal
    new SlashCommandBuilder().setName('nepal').setDescription('Sends a message to the channel.')
...
    // Admin check — allow anyone to use /nepal
...
        await interaction.reply({ content: 'Sending your message to the channel...', ephemeral: true });
